...
def test1():
        cursor.execute("SELECT r_closed1,a_closed1,d_closed1 from d_test limit 1000")
...
def test2():
        cursor.execute("SELECT accuracy,a_accuracy,d_accuracy from d_accuracy1 order by sno asc limit 5")
        results = cursor.fetchall()
        random_forest = []
        ada_boost = []
        d_algo = []     
...
def test3():
        cursor.execute("SELECT accuracy,a_accuracy,d_accuracy from d_accuracy where sno>3")
        results = cursor.fetchall()
        random_forest = []
        ada_boost = []
        d_algo = []
